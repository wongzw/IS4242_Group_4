...
# replace this with updated image with motion based letters crossed out.
        ...
        if len(x_points) == 21 or len(x_points) == 42:
            ...
            if len(target) > 0:
                ...
                mpdraw.draw_landmarks(
                    frame, landmarks, mphands.HAND_CONNECTIONS)

                # Show text predicted
                # cv2.putText(frame, (all_alphabets[int(predicted[0])]).upper() + " ", (80, 80), cv2.FONT_ITALIC, 2, (255, 100, 100), 2)
                cv2.putText(frame, process_output(choice, predicted),
                            (80, 80), cv2.FONT_ITALIC, 2, (255, 191, 0), 4)
